            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Data Obat">Antrian</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                          <a href="{{ route('daftar-antrian') }}" class="menu-link">
                            <div data-i18n="Account">Daftar Antrian</div>
                          </a>
                        </li>
                        <li class="menu-item">
                    ...
                    <li class="nav-item ms-auto navbar-dropdown dropdown-user dropdown ">
                        <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                            <div class="avatar avatar-online">
                                @if (Auth::user()->gambar)
                                <img src="{{ asset('/storage/images/'.Auth::user()->gambar) }}" alt class="w-px-40 h-auto rounded-circle" />
                                @else
                                <img src="{{ asset('/assets/admin_template/img/avatars/none.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                                @endif
                            </div>
                        </a>
